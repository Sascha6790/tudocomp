...
TEST(_RELEVANT_FILES_MEMORY_, LZ77SingleHashingMode1) {
    uint mode = 1;
...
TEST(_RELEVANT_FILES_MEMORY_, LZ77SingleHashingMode2) {
    uint mode = 2;
...
TEST(_RELEVANT_FILES_MEMORY_, LZ77CompactTries) {
    uint mode = 0;
...
TEST(_RELEVANT_FILES_MEMORY_, LZ77DoubleHashing_Mode1) {
    uint mode = 1;
...
TEST(_RELEVANT_FILES_MEMORY_, LZ77DoubleHashing_Mode2) {
    uint mode = 2;
...
TEST(_RELEVANT_FILES_MEMORY_, LZ77MatchingStatistics) {
    uint mode = 0;
...
TEST(_RELEVANT_FILES_MEMORY_, LZ77SuffixSorting) {
    uint mode = 0;
